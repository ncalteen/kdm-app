...
create policy "Allow select for owner" on settlement_milestone for
...
create policy "Allow update for owner" on settlement_milestone for
...
create policy "Allow delete for owner" on settlement_milestone for delete to authenticated using (
  exists (
    select 1
    from settlement s
    where s.id = settlement_id
...
create policy "Allow select for shared" on settlement_milestone for
select to authenticated using (
    exists (
      select 1
...
create policy "Allow all for admin" on settlement_milestone for all using (is_admin()) with check (is_admin());
--------------------------------------------------------------------------------
-- Indexes
--------------------------------------------------------------------------------
