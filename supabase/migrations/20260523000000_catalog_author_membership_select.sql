...
-- contract in `docs/settlement-sharing-architecture.md` Appendix B EC-7
-- explicitly says A should lose access. The author-membership clause closes
-- that gap.
--
-- This migration:
--
...
--
-- Citations:
--   docs/settlement-sharing-architecture.md Appendix B EC-7
