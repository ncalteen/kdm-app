...
--
-- Implements EC-6 from docs/settlement-sharing-architecture.md: when a custom
-- catalog row (e.g. a user-authored knowledge or quarry) is attached to a
-- settlement, everyone who can SEE that settlement (the owner and any
-- collaborators) can also SEE the catalog row's full content.
--
...
--
-- Citations:
--   docs/settlement-sharing-architecture.md §10 Phase 2 (2.1, 2.2)
--   docs/settlement-sharing-architecture.md Appendix B EC-6
--------------------------------------------------------------------------------
