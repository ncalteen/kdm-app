...
export async function getPeopleOfTheSunTemplate(): Promise<CampaignTemplate> {
  return {
    ...
    nemesisIds: await getNemesisIds(
      ['Butcher', 'The Great Devourer (Sunstalker)', 'The Hand', "King's Man"],
      false
    ),
    ...
    timeline: [
      ...
      // Year 1
      { year_number: 1, entries: ['The Pool and the Sun'] },
      // Year 2
      { year_number: 2, entries: [] },
      // Year 3
      { year_number: 3, entries: [] },
      // Year 4
      { year_number: 4, entries: ['Sun Dipping'] },
      // Year 5
      { year_number: 5, entries: ['The Great Sky Gift'] },
      // Year 6
      ...
      // Year 10
      { year_number: 10, entries: ['Birth of Color'] },
      // Year 11
      { year_number: 11, entries: ['Principle: Conviction'] },
      // Year 12
      { year_number: 12, entries: ['Sun Dipping'] },
      // Year 13
      { year_number: 13, entries: ['The Great Sky Gift'] },
      // Year 14
      ...
      // Year 19
      { year_number: 19, entries: ['Sun Dipping'] },
      // Year 20
      { year_number: 20, entries: ['Final Gift'] },
      // Year 21
