...
/**
 * Get People of the Stars Campaign Template
 *
 * @returns People of the Stars Campaign Template
 */
export async function getPeopleOfTheStarsTemplate(): Promise<CampaignTemplate> {
  return {
    collectiveCognitionRewardIds: await getCollectiveCognitionRewardIds(
      [...coreCollectiveCognitionRewards, 'Facets of Existence'],
      false
    ),
    innovationIds: await getInnovationIds(['Dragon Speech'], false),
    ...
    milestoneIds: await getMilestoneIds(
      [...coreMilestones, 'First child is born'],
    ...
    timeline: [
      ...
      // Year 1
      { year_number: 1, entries: ['Foundlings'] },
      // Year 2
      ...
      // Year 5
      { year_number: 5, entries: ["Midnight's Children"] },
      // Year 6
      ...
      // Year 10
      { year_number: 10, entries: ['Unveil the Sky'] },
      // Year 11
      ...
      // Year 20
      { year_number: 20, entries: ["The Dragon's Tomb"] },
      // Year 21
