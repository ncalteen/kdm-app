 ...
 *
 * See `docs/settlement-sharing-architecture.md` §10 Phase [E1.9] and the [E1.3]
 * trigger `enforce_settlement_owner_only_columns` for the full list of
 * rejection sources this maps.
 */
