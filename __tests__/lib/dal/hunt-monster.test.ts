...
const { getHuntMonsters, addHuntMonster, updateHuntMonster, removeHuntMonster } =
...
describe('getHuntMonsters', () => {
  ...
  it('returns a map of hunt monsters with ai_deck', async () => {
    const rawMonster = {
      ...
      hunt_id: 'hunt-1',
      hunt_ai_deck: { id: 'deck-1', basic_cards: 5, advanced_cards: 2, legendary_cards: 0, overtone_cards: 1 }
    }
...
describe('addHuntMonster', () => {
  it('inserts a hunt monster and returns the id', async () => {
    ...
    const result = await addHuntMonster({ hunt_id: 'hunt-1', monster_name: 'White Lion' })
  ...
  it('throws when insert fails', async () => {
    ...
    await expect(
      addHuntMonster({ hunt_id: 'hunt-1', monster_name: 'White Lion' })
...
describe('updateHuntMonster', () => {
  it('updates a hunt monster successfully', async () => {
    ...
    await expect(updateHuntMonster('monster-1', { wounds: 3 })).resolves.toBeUndefined()
