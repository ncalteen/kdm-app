...
const {
  getSeedPatternSharedUsers,
  addSeedPatternSharedUsers,
  removeSeedPatternSharedUsers
} = await import('@/lib/dal/seed-pattern-shared-user')
...
describe('addSeedPatternSharedUsers', () => {
  ...
  it('inserts shared users correctly', async () => {
    ...
    expect(mockInsert).toHaveBeenCalledWith([
      {
        seed_pattern_id: 'seed_pattern-1',
        shared_user_id: 'u-1',
        user_id: 'user-1'
      },
      {
